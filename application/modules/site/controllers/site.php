...
//=====(:any)-m(:num)l(:num)t(:num).html(/:num)?
    ...
    else if(!empty( CheckCity($place)) && intval($subject)==0 && intval($class)==0 && intval($district)==0 && empty($key))
    {
...
//===='tim-gia-su?key=(:any)&subject=(:num)&topic=(:num)&place=(:num)&district=(:num)&type=(:num)&sex=(:num)&order=(:any)(/:num)
  ...
  function tutorresultteacher($keywork,$subject,$topic,$place,$type,$sex,$order)
  {
   ...
   $class = '';
   $order = 'last';
   $result=$this->site_model->GetListTeacherBySearch($keywork,$subject,$class,$topic,$place,$type,$sex,$order,0,20);
      ...
      $userid=0;
        ...
        if($lsttopic['kq'] ==true){
          ...
          $lsttopic=$this->site_model->UpdateTeacher($userid,$hinhthucday,GetLearn($hinhthucday),$hientaila,$hocphi,$sang2,$chieu2,$toi2,$sang3,$chieu3,$toi3,
            $sang4,$chieu4,$toi4,$sang5,$chieu5,$toi5,$sang6,$chieu6,$toi6,$sang7,$chieu7,$toi7,$sang8,$chieu8,$toi8,$imgcmnd,$TitleView,$chitietnoidung,$hoctruong,$chuyennganh,$namtotnghiep,$noicongtac);
          if($lsttopic['kq'] ==true){
