...
<section class="padd-top-10 padd-bot-30">
                        ...
                        <?php if(!empty($lstonline)){
                            foreach($lstonline as $n){ ?>
                                <div class="item-uv-online">
                                    ...
                                    <div class="item-uv-name"><a href="">Học phí: <?php echo number_format($n->Money)." vnđ/h" ?> </a><span><span>Địa điểm:</span> <?php echo Getcitybyindex($n->City); ?></span>
                                    </div>
    ...
    <div class="container">
        <div class="row uvmienphi">
            <div class="col-md-4 col-sm-12 padd-r-5">
            ...
            <div class="col-md-4 col-sm-12 padd-l-10 padd-r-10">
