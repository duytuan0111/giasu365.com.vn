        ...
        <div class="manager-col-right col-md-9 col-sm-12">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <?php $tgsex=explode($uclass->TeacherSex); ?>
                                ...
                                <div class="form-group lblcheck">
                                    <input value="1" <?php if(in_array("1", $tgsex, TRUE)){ ?>checked="checked"<?php } ?> checked="checked" name="location1" id="location1" type="checkbox">
                                    <label for="location1">Nam</label>                                     
                                </div>
                                <div class="form-group lblcheck">
                                    <input value="2" <?php if(in_array("2", $tgsex, TRUE)){ ?>checked="checked"<?php } ?> name="location2" id="location2" type="checkbox">
            ...
            $data.="</li>"; 
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 col-sm-12 divyeucau phuhuynhyc">
                    <div class="row">
                        <h4><i class="fa fa-plus-circle"></i> Đăng tin tìm gia sư 1</h4>
                        <div class="col-md-10 col-md-offset-1">
                            <label>Tóm tắt yêu cầu tìm gia sư</label>
                            <div class="form-control">
                            ...
                            <div class="form-inline">
                                ...
                                <label style="margin-right:30px;">Giới tính: </label>
                                <div class="form-group lblcheck">
                                    <input value="1" checked="checked" checked="checked" name="location1" id="location1" type="checkbox">
                                    <label for="location1">Nam</label>                                     
                                </div>
                                <div class="form-group lblcheck">
