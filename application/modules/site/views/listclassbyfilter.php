    ...
    <div class="container">
        <div class="row">
            <div class="col-md-70 col-sm-12">
                <div class="searchclasstitle">
                    <h1 class="vltg">
                        <i class="fa fa-uv-newsest"></i>
                        <span>
                            <?php
                            if(strtolower($keywork)=='all')
                            {
                                echo "Tổng hợp lớp cần gia sư";
                            }
                            else
                            {
                ...
                <div class="main_itg">
                    ...
                    if(!empty($lstitem)){
                        ...
                        echo "<div class='col-md-12'>Không tìm thấy lớp phù hợp</div>";
                    } 
                    ?>
                    <?php if(!empty($lienquan)){ ?>
                    <div class="box_job_search tagwork uvonline">
                        <h2>Lớp cần gia sư liên quan</h2>
