        ...
        <div class="row">
            <div class="col-md-70 col-sm-12">
                <div class="titlesearch">                 
                   <h3 class="vltg"><i class="fa fa-uv-newsest"></i> <span>Danh sách lớp theo yêu cầu tìm kiếm</span></h3>                
                </div> 
                <div class="main_itg main_lop">
                    <?php
                        if(!empty($lstitem)){
                    ...
                    <div class="list_workonline">
                        <?php if(!empty($lstonline)){
                            ...
                            <div class="item-uv-online">
                                ...
                                <div class="item-uv-name"><a href="">Học phí: <?php echo number_format($n->Money)." vnđ/h" ?> </a><span><span>Địa điểm:</span> <?php echo Getcitybyindex($n->City); ?></span></div>
        ...
        $.ajax(
              {
                  ...
                  type: "POST",
                  data: { key:findkey,subject:strsubj,place:strtinhthanh,type:strtype,sex:strgioitinh },
                  dataType: 'json',
                  beforeSend: function () {
                      $("#boxLoading").show();
                  },
