	...
	<table width="100%" style="display:block;">
		...
		if($query !='')
		{
			...
			foreach($query as $item)
			{
			  ...
			  //}else{
							?>
							<a class="status" onclick="check_statusck('users','Active',0,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/tick.png"></a>
							<?php 
						}
						else
						{
							?>
							<a class="status" onclick="check_statusck('users','Active',1,'UserID',<?php echo $item->UserID; ?>)"><img src="images/toolbar/publish_x.png"></a>
							<?php
						}
						?>
					</td> 
