...
function vn_str_filter ($str){
	...
	$unicode = array(
		...
		'o'=>'ó|ò|ỏ|õ|ọ|ô|ố|ồ|ổ|ỗ|ộ|ơ|ớ|ờ|ở|ỡ|ợ|ợ|Ó|Ò|Ỏ|Õ|Ọ|Ô|Ố|Ồ|Ổ|Ỗ|Ộ|Ơ|Ớ|Ờ|Ở|Ỡ|Ợ',
...
function sendsms($mobile,$message)
{
	...
	// authenticate to the service: Nhập user với password của bạn vào đây
        $client->setCredentials('timviec365', 'timviec@#$365');
	...
	'string1' => "timviec365", //'SERVICE_ID: neu BrandName thi dien BrandName vao
	'string2' => "timviec365", // Command_code: neu BrandName thi dien BrandName vao
